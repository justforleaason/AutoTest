...
async function runTest() {
    ...
    try {
		...
		await driver.sleep(3000);
		// Вивід назви і ціни товару
        let productInfo = await driver.findElement(By.css('.product-information'));
        let productName = await productInfo.findElement(By.css('h2')).getText();
        let productPrice = await productInfo.findElement(By.css('span span')).getText();
